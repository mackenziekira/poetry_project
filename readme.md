...
<p>Inside the repo that you just cloned, create a virtual environment:
    ```
    virtualenv env
    ```
    enter the virtual env:<br/><code>source env/bin/activate</code><br/>and install all required libraries:<br/><code>pip install -r requirements.txt</code><br/> Note best practices and make sure you add your env folder to your .gitignore file (<code>echo '/env' >> .gitignore</code>).</p>
